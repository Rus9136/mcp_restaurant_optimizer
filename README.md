...
- **Reviews API** - получение отзывов по подразделениям

### ✅ Интеграции  
- **Aqniet API** - получение данных о филиалах и продажах
- **Madlen API** - управление HR данными и расписаниями
- **Reviews API** - интеграция с reviews.aqniet.site для получения отзывов
...
# Получение отзывов (Новое!)
curl https://mcp.madlen.space/api/v1/mcp/reviews/c3c76c7c-bead-4be2-88ce-7d7415aeabe4/5
```
...
- **Reviews**: JSON массив отзывов с рейтингами и текстом
...
- ✅ **Отзывы API**: Интеграция с reviews.aqniet.site (2025-07-12)
...
### 🆕 Эндпоинт отзывов (2025-07-12)
- **URL**: `GET /api/v1/mcp/reviews/{department_id}/{count}`
- **Источник**: reviews.aqniet.site API
- **Кэширование**: 30 минут
- **Валидация**: count от 1 до 1000
- **Обработка ошибок**: Специфичные коды для разных случаев

Пример использования:
```bash
# Получить 5 последних отзывов
curl https://mcp.madlen.space/api/v1/mcp/reviews/c3c76c7c-bead-4be2-88ce-7d7415aeabe4/5
```